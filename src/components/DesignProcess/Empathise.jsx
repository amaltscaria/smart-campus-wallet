...
const Empathise = () => {
  ...
  // Interview Planning content as separate sections
  ...
  return (
    <div className="mb-16">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h4 className="text-xl font-semibold mb-6 text-left">Interview Planning</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative group">
            <div className="h-[500px] flex items-center justify-center bg-transparent rounded-lg">
              <img
                src={interviewTopicsImage}
                alt="Interview Topics and Planning"
                className="rounded-lg shadow-sm max-w-full max-h-full object-contain cursor-pointer hover:scale-105 transition-all duration-300"
                onClick={() => setSelectedImage({ src: interviewTopicsImage, alt: "Interview Topics and Planning" })}
              />
            </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h4 className="text-xl font-semibold mb-6 text-left">Participant Recruitment Strategy</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative group">
            <div className="h-[500px] flex items-center justify-center bg-transparent rounded-lg">
              <img
                src={participantAdvertImage}
                alt="Participant Recruitment Advertisement"
                className="rounded-lg shadow-sm max-w-full max-h-full object-contain cursor-pointer hover:scale-105 transition-all duration-300"
                onClick={() => setSelectedImage({ src: participantAdvertImage, alt: "Participant Recruitment Advertisement" })}
              />
            </div>
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
              <div className="w-10 h-10 bg-white rounded flex items-center justify-center shadow-md">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h4 className="text-xl font-semibold mb-6 text-left h-[30px] flex items-center">{insightSlides[currentInsightSlide].title}</h4>

        <div className={`transition-all duration-1200 ease-in-out ${isInsightTransitioning ? 'opacity-0' : 'opacity-100'}`}>
          {/* Single column layout with content */}
          <div className="mb-6 h-[120px] flex items-start">
            <div>
              <p className="text-gray-700 text-left mb-4">
                {insightSlides[currentInsightSlide].description}
              </p>
              {insightSlides[currentInsightSlide].content && (
      ...
      {/* Competitor Analysis */}
      <div className="bg-white rounded-lg shadow-md p-6 pb-8 mb-8 mt-8">
