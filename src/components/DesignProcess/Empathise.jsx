...
const Empathise = () => {
  ...
  const insightSlides = [
    {
      id: 1,
      image: "/images/research/Interview evaluation - Affinity Map..jpg",
    ...
    {
      id: 2,
      image: "/images/new/9.Insight clusters.jpg",
  ...
  const recruitmentSlides = [
    {
      id: 1,
      image: "/images/research/Set interview topics.jpg",
    ...
    {
      id: 2,
      image: "/images/research/Participants N﻿eeded Advert.jpg",
  ...
  const participantSlides = [
    {
      id: 1,
      image: "/images/research/Participant Summary Table1.jpg",
    ...
    {
      id: 2,
      image: "/images/research/Participant Summary Table.jpg",
  ...
  return (
    <div className="mb-16">
      <h3 className="text-2xl font-bold mb-6 text-center text-white">Empathise</h3>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative group">
            <img
              src="/images/research/User﻿ Interview Insights.jpg"
              ...
              onClick={() => setSelectedImage({ src: "/images/research/User﻿ Interview Insights.jpg", alt: "User Interview Insights" })}
            />
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
              <div className="w-10 h-10 bg-white rounded flex items-center justify-center shadow-md">
                <svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative group">
            <img
              src="/images/new/5. Competitor analysis.jpg"
              alt="Competitor Analysis"
              className="rounded-lg shadow-sm w-full h-auto cursor-pointer hover:scale-105 transition-all duration-300"
              onClick={() => setSelectedImage({ src: "/images/new/5. Competitor analysis.jpg", alt: "Competitor Analysis" })}
            />
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
              <div className="w-10 h-10 bg-white rounded flex items-center justify-center shadow-md">
                <svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
